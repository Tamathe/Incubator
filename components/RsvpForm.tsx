...
export default function RsvpForm() {
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    e.preventDefault();
    // No backend yet — see README "Loose ends".
    setSubmitted(true);
  }
      ...
      <form onSubmit={handleSubmit}>
        <div style={{ display: "grid", gap: 18 }}>
          <div>
            ...
            <div
              className="field"
              style={{ borderRadius: 10, paddingLeft: 16 }}
            >
              <input placeholder="First Last" required />
            </div>
          </div>
          <div
            style={{
          ...
          >
            <div>
              ...
              <div
                ...
                style={{ borderRadius: 10, paddingLeft: 16 }}
              >
                <input type="email" placeholder="name@uky.edu" required />
              </div>
            </div>
            <div>
              <label
